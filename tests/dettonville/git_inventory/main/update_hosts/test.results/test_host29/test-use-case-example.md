...
ok: [localhost] =>
  changed: false
  exception: "Traceback (most recent call last):\n  File \"/root/.ansible/tmp/ansible-tmp-1754491657.7300267-33607-51192092225668/AnsiballZ_update_hosts.py\",
    line 107, in <module>\n    _ansiballz_main()\n  File \"/root/.ansible/tmp/ansible-tmp-1754491657.7300267-33607-51192092225668/AnsiballZ_update_hosts.py\",
    ...
    line 88, in _run_code\n  File \"/tmp/ansible_dettonville.git_inventory.update_hosts_payload_sc2vh2ex/ansible_dettonville.git_inventory.update_hosts_payload.zip/ansible_collections/dettonville/git_inventory/plugins/modules/update_hosts.py\",
    line 574, in <module>\n  File \"/tmp/ansible_dettonville.git_inventory.update_hosts_payload_sc2vh2ex/ansible_dettonville.git_inventory.update_hosts_payload.zip/ansible_collections/dettonville/git_inventory/plugins/modules/update_hosts.py\",
    line 570, in main\n  File \"/tmp/ansible_dettonville.git_inventory.update_hosts_payload_sc2vh2ex/ansible_dettonville.git_inventory.update_hosts_payload.zip/ansible_collections/dettonville/git_inventory/plugins/modules/update_hosts.py\",
    line 559, in run_module\n  File \"/tmp/ansible_dettonville.git_inventory.update_hosts_payload_sc2vh2ex/ansible_dettonville.git_inventory.update_hosts_payload.zip/ansible_collections/dettonville/git_inventory/plugins/module_utils/git_inventory_updater.py\",
    line 360, in update_inventory\n  File \"/tmp/ansible_dettonville.git_inventory.update_hosts_payload_sc2vh2ex/ansible_dettonville.git_inventory.update_hosts_payload.zip/ansible_collections/dettonville/git_inventory/plugins/module_utils/inventory_parser.py\",
  ...
  module_stdout: 'INFO:root:GitInventoryUpdater.get_internal_collection_version(): module_parts=[''dettonville.git_inventory'',
    ...
    INFO:root:GitInventoryUpdater.init(): inventory_base_dir => /tmp/update_inventoryt4ifyb3a
    ...
    /tmp/update_inventoryt4ifyb3a with env: {''LANG'': ''C'', ''LC_ALL'': ''C'', ''LC_MESSAGES'':
    ''C'', ''LC_CTYPE'': ''C'', ''GIT_SSH_COMMAND'': ''ssh -i /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_xbzsdaw0/ansible_repo.key
    ...
    ''GIT_COMMITTER_EMAIL'': ''ansible@example.org''} in cwd: /tmp/update_inventoryt4ifyb3a
    ...
    ''C'', ''GIT_SSH_COMMAND'': ''ssh -i /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_xbzsdaw0/ansible_repo.key
    -o IdentitiesOnly=yes -o BatchMode=yes -o StrictHostKeyChecking=no'', ''GIT_AUTHOR_NAME'':
    ''ansible'', ''GIT_COMMITTER_NAME'': ''ansible'', ''GIT_AUTHOR_EMAIL'': ''ansible@example.org'',
    ''GIT_COMMITTER_EMAIL'': ''ansible@example.org''} in cwd: /tmp/update_inventoryt4ifyb3a
    ...
    INFO:root:InventoryParser.init(): inventory_base_dir=/tmp/update_inventoryt4ifyb3a
