...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main 8ee6d67] JENKINS-68 - dettonville.git_inventory.update_inventory:
    updated inventory\n 3 files changed, 41 insertions(+), 20 deletions(-)\n create
    mode 100644 tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/host_vars/vmlnx123.qa.site1.example.int.yml\n
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   9ceaba1..8ee6d67
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventorysehn6x7r
