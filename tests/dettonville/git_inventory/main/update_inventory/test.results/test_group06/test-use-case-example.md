...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_g573rn1m/ansible_repo.key
    state: absent
...
ok: [localhost] =>
  ...
  check_mode: false
  failed: false
  inventory_base_dir: /tmp/update_inventorynehy69f4
