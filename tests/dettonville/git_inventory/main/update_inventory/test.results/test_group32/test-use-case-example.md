...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main b565b60] JENKINS-68 - dettonville.git_inventory.update_inventory:
    Test setting the git_comment_body\n 1 file changed, 34 insertions(+), 19 deletions(-)\n"
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   a7aaf6a..b565b60
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory37upo6p1
