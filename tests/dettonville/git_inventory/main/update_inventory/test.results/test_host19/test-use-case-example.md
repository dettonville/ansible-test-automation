...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main 038bb1b] JENKINS-68 - dettonville.git_inventory.update_inventory:
    updated inventory\n 2 files changed, 29 insertions(+), 37 deletions(-)\n rewrite
    tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/host_vars/test123.qa.site1.example.int.yml
    (96%)\n"
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   4055b18..038bb1b
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventoryc72co55t
