...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main b290da2] JENKINS-68 - dettonville.git_inventory.update_inventory:
    updated inventory\n 2 files changed, 25 insertions(+), 20 deletions(-)\n create
    mode 100644 tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/group_vars/ocp_common.yml\n"
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   6f5f3fb..b290da2
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory_25j5icr
