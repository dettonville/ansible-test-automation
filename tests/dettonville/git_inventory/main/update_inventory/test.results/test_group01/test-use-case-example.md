...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_zgtla97u/ansible_repo.key
...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main c569927] JENKINS-53 -  - dettonville.git_inventory.update_inventory:
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   a0ddfd6..c569927
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventoryk6iuxd08
