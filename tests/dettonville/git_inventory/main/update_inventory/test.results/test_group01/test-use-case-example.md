...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_aldl30xi/ansible_repo.key
...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main e3c30fe] JENKINS-98 -  - dettonville.git_inventory.update_inventory:
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   2c3b3a3..e3c30fe
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory7vkweugj
