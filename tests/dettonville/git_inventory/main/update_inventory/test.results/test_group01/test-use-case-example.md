...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_x7iqm8ga/ansible_repo.key
...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main 190b799] PR-2648 - dettonville.git_inventory.update_inventory:
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   8b2dba7..190b799
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventorybfjuqnxh
