...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_h9kdh1ng/ansible_repo.key
...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main 57e4d9f] JENKINS-105 -  - dettonville.git_inventory.update_inventory:
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   45647de..57e4d9f
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventoryl8klvni4
