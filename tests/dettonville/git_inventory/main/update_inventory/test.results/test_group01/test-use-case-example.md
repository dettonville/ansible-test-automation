...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /home/jenkins/agent/workspace/_inventory_run-module-tests_main@tmp/.ansible/tmp/.test_jobs_hjqxtyzp/ansible_repo.key
...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main c5d2e24] JENKINS-50 -  - dettonville.git_inventory.update_inventory:
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   b326337..c5d2e24
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory3mdgf723
