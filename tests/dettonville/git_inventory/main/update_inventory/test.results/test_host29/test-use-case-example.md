...
- name: "Run test on dettonville.git_inventory.update_inventory"
  ...
  dettonville.git_inventory.update_inventory:
    ...
    ssh_params:
      accept_hostkey: true
      key_file: /Users/ljohnson/.ansible/tmp/.test_jobs_5vt7inc4/ansible_repo.key
...
ok: [localhost] =>
  changed: false
  failed: true
  msg: 'InventoryParser.validate_global_group_exists(foobar): group_name=[foobar] not
    found in xenv_groups.yml'
