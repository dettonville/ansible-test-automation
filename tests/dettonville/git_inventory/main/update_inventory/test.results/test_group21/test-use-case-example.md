...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main e88f86f] JENKINS-68 - dettonville.git_inventory.update_inventory:
    updated inventory\n 2 files changed, 29 insertions(+), 37 deletions(-)\n rewrite
    tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/group_vars/ocp_common.yml
    (96%)\n"
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   4894086..e88f86f
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory0ui50d4k
