...
ok: [localhost] =>
  ...
  failed: false
  git.add: ''
  git.commit: "[main cf23dd5] JENKINS-68 - dettonville.git_inventory.update_inventory:
    updated inventory\n 3 files changed, 20 insertions(+), 26 deletions(-)\n delete
    mode 100644 tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/host_vars/test123.dev.site1.example.int.yml\n
    delete mode 100644 tests/dettonville/git_inventory/main/update_inventory/testrun/_test_inventory/SANDBOX/host_vars/test123.qa.site1.example.int.yml\n"
  ...
  git.push: "To github.com:dettonville/ansible-test-automation.git\n   8777dd7..cf23dd5
    \ main -> main\n"
  inventory_base_dir: /tmp/update_inventory49ks0xwg
