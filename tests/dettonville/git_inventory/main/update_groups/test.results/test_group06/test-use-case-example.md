...
- name: "Run test on dettonville.git_inventory.update_groups"
  ...
  dettonville.git_inventory.update_groups:
    ...
    inventory_file: tests/dettonville/git_inventory/main/update_groups/testrun/_test_inventory/SANDBOX/hosts.yml
...
ok: [localhost] =>
  ...
  check_mode: false
  failed: false
  inventory_base_dir: /tmp/update_inventoryqkuh3eod
