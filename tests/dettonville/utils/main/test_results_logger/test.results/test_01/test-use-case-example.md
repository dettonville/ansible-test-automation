...
- name: "Run test on dettonville.utils.test_results_logger"
  ...
  dettonville.utils.test_results_logger:
    test_case_base_dir: /home/jenkins/agent/workspace/ible-utils_run-module-tests_main/test-results/tests/dettonville/utils/main/test_results_logger/testrun/vars/tests
    test_case_file_prefix: testdata_
    test_results_dir: /home/jenkins/agent/workspace/ible-utils_run-module-tests_main/test-results/tests/dettonville/utils/main/test_results_logger/testrun/test-results
...
ok: [localhost] =>
  changed: true
  failed: false
  message: The test results file has been created successfully at /home/jenkins/agent/workspace/ible-utils_run-module-tests_main/test-results/tests/dettonville/utils/main/test_results_logger/testrun/test-results/junit-report.xml
...
```xml
<?xml version="1.0" ?>
<testsuites assertions="0" disabled="0" errors="0" failures="0" skipped="7" tests="7" time="0.0">
	<testsuite disabled="0" errors="0" failures="0" name="export_dicts" skipped="4" tests="4" time="0">
		<testcase name="01" classname="export_dicts">
			<skipped type="skipped">test_suite_id:test_case_id=export_dicts:01 skipped</skipped>
		</testcase>
		<testcase name="02" classname="export_dicts">
			<skipped type="skipped">test_suite_id:test_case_id=export_dicts:02 skipped</skipped>
		</testcase>
		<testcase name="03" classname="export_dicts">
			<skipped type="skipped">test_suite_id:test_case_id=export_dicts:03 skipped</skipped>
		</testcase>
  ...
  export_dicts: !TestSuite
    ...
    test_cases:
      '01': !TestCase
        ...
        skipped:
        - message:
          output: test_suite_id:test_case_id=export_dicts:01 skipped
      ...
      '03': !TestCase
        ...
        skipped:
        - message:
          output: test_suite_id:test_case_id=export_dicts:03 skipped
        allow_multiple_subelements: false
      '04': !TestCase
        name: '04'
        assertions:
