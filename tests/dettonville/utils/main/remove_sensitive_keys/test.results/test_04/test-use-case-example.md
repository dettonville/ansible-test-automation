...
Use Case [04]: dict object - remove sensitive keys with both key_patterns and additional_key_patterns defined
  ...
  ansible.builtin.set_fact:
    test_object: 
      ...
      ansible_date_time:
        ...
        day: '17'
        epoch: '1705509224'
        epoch_int: '1705509224'
        hour: '10'
        iso8601: '2024-01-17T16:33:44Z'
        iso8601_basic: 20240117T103344253096
        iso8601_basic_short: 20240117T103344
        iso8601_micro: '2024-01-17T16:33:44.253096Z'
        minute: '33'
        month: '01'
        second: '44'
        time: '10:33:44'
      ...
      ansible_device_links:
        ids:
          dm-0:
          - dm-name-rhel00-root
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9DaKK8In8X6I4nDHhsamz2Uxrzxx4PEN1v
          dm-1:
          - dm-name-rhel00-swap
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9DCN4dfeoxKpiZZcPit8dkRRRoqt2SgQog
          dm-2:
          - dm-name-rhel00-var
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9DyDetqV2lmrGZR00A8nt0rQrRfGqRqgHV
          dm-3:
          - dm-name-rhel00-home
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9Df6Kg0fMK1pkiedlh1JlLdRwn6LgvxznL
          dm-4:
          - dm-name-rhel00-opt
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9DPuCdzd2s4NlFVjeL01e4vhOlMrYWzpZU
          dm-5:
          - dm-name-rhel00-tmp
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9DGhNWabkYQhxq5PF1tMRwhyhC3cTPowOQ
          dm-6:
          - dm-name-rhel00-data
          - dm-uuid-LVM-vjshCGtn9EvFfXkpCMJGHOtSbX1n6y9Ddj6j2o4lNHchglwBTTodfouwAhQNgjiN
          sda3:
          - lvm-pv-uuid-HON16d-9DOE-90za-rbqA-8URm-hmzi-vFO6qf
          sdb1:
          - lvm-pv-uuid-dCzWl4-d5kl-Ftuv-N8bE-3E1a-3rBR-rTm3B0
          sr0:
        ...
        uuids:
          dm-0:
          - 4bcb5b38-fa37-4d1a-a0d2-fa90f4e6fbb1
          dm-1:
          - df788836-fd16-411c-ae14-6567e94070da
          dm-2:
          - e00d6c2c-e747-48a6-bbb8-d16ec51564a0
          dm-3:
          - 342139a4-173c-4778-b151-999ce0b06340
          dm-4:
          - 27273ce5-af80-487f-874d-16665bcdbc10
          dm-5:
          - d9bd6c00-8a6c-4f70-b9bf-84f0be75af6e
          dm-6:
          - 844f4d0a-c9f5-47b3-9e24-e2422c3870e1
          sda1:
          - F527-53C8
          sda2:
          - 26729a20-ff8e-41a4-8101-2d9bd7a46809
      ansible_devices:
        dm-0:
          holders: []
          host: ''
        ...
        sda:
          ...
          partitions:
            ...
            sda2:
              ...
              size: 1.00 GB
              start: '1230848'
              uuid: 26729a20-ff8e-41a4-8101-2d9bd7a46809
            sda3:
              holders:
              - rhel00-swap
              - rhel00-opt
...
- name: "Run test on dettonville.utils.remove_sensitive_keys"
  ignore_errors: yes
  ansible.builtin.set_fact:
    __test_filter_result: "{{ test_object | dettonville.utils.remove_sensitive_keys(key_patterns=['(?i).*vault.*', '(?i).*token.*', '(?i).*password.*', '(?i).*key.*'], additional_key_patterns=['(?i).*root.*']) }}"
  ...
  ansible_facts:
    __test_filter_result:
      ...
      ansible_devices:
        ...
        sda:
          holders: []
          host: 'Serial Attached SCSI controller: VMware PVSCSI SCSI Controller (rev
            02)'
          links:
            ids: []
            labels: []
